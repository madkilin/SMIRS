                            ...
                            <div class="card">
                                <div class="card-body px-4 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                            <h6 class="text-muted font-semibold">Total Pemasok</h6>
                            ...
                            <div class="card">
                                <div class="card-body px-4 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                            <h6 class="text-muted font-semibold">Jumlah Inventaris</h6>
                            ...
                            <div class="card">
                                <div class="card-body px-4 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                            <h6 class="text-muted font-semibold">Total Inventaris di Gudang</h6>
                                            <h6 class="font-extrabold mb-0">{{ $totalWH }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body px-4 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                            <h6 class="text-muted font-semibold">Total Inventaris Teralokasi</h6>
                                            <h6 class="font-extrabold mb-0">{{ $totalAI }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="avatar avatar-xl">
                                    @if ($user->profile_photo != null)
                                        <img src="{{ asset('storage/' . $user->profile_photo) }}" alt="Avatar"
                                            width="32" height="32" />
                                    @else
                                        <img src="{{ asset('default/image/user.jpg') }}" alt="Default Avatar" width="32"
                                            height="32" />
                                    @endif
                                </div>
                                <div class="ms-3 name">
