            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form id="createLocationForm" action="{{ route('admin.locations.store') }}" method="POST" class="form" data-parsley-validate>
                                @csrf
                                <div class="row">
        ...
        document.getElementById('saveButton').addEventListener('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Submit the form
                    document.getElementById('createLocationForm').submit();
                }
            });
        });
    </script>
