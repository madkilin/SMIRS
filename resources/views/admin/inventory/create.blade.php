            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form id="createInventornForm" action="{{ route('admin.inventory.store') }}" method="POST" enctype="multipart/form-data" class="form" data-parsley-validate>
                                @csrf
                                <div class="row">
                                    <!-- Name Input -->
        ...
        document.getElementById('saveButton').addEventListener('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Submit the form
                    document.getElementById('createInventornForm').submit();
                }
            });
        });
    </script>
