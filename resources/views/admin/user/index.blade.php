            ...
            <div class="card">
                ...
                @endif
                    @if (Auth::user()->role_id == 1)
                        ...
                        <div class="buttons">
                            <a href="{{ route('admin.users.create') }}" class="btn icon btn-primary"><i
                                    class="bi bi-person-plus-fill me-2"></i>Tambah</a>
                        </div>
                    @endif
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a data-bs-toggle="modal"
                                                    data-bs-target="#exampleModalCenter_{{ $user->id }}" href="#">
                                                    <img src="{{ asset('default/image/user.jpg') }}" alt="Default Avatar"
                                                        width="32" height="32" />
                                                </a>
                                            @endif
                                        </td>
                                        @if (Auth::user()->role_id == 1)
                                            <!-- Hanya tampilkan aksi untuk admin -->
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    <a href="{{ route('admin.users.edit', $user->id) }}"
                                                        class="btn btn-primary me-1 mb-1"><i
