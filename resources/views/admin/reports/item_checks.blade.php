        ...
        <section class="section">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="buttons">
                        <div class="dropdown">
                            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButtonForFilter"
                                ...
                                <form method="GET" action="{{ route('admin.reports.item_checks') }}">
                                    <div class="mb-2">
                                        ...
                                        <select name="status" id="status" class="form-select">
                                            ...
                                            <option value="bagus" {{ request('status') == 'bagus' ? 'selected' : '' }}>
                                                Bagus</option>
                                            ...
                                            <option value="perbaikan"
                                                {{ request('status') == 'perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                                        </select>
                                    </div>
                                    <div class="mb-2">
                            ...
                            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButtonForExport"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Export
                            </button>
