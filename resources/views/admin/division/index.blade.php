                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start">
                                        ...
                                        <form id="deleteDivisionForm-{{ $division->id }}" action="{{ route('admin.divisions.destroy', $division->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" id="deleteButton-{{ $division->id }}" class="btn btn-danger me-1 mb-1">
