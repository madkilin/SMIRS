...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5">Silakan hubungi <a href="https://wa.me/628812248087?text=I'm%20interested%20in%20your%20car%20for%20sale" target="_blank" class="text-bold">admin</a></p>
            <p class='text-center mt-5 text-lg fs-4 text-gray-600'>Ingat akun anda? <a href="auth-login.html" class="font-bold">Login</a>.
        </div>
    </div>
    <div class="col-lg-7 d-none d-lg-block">
        <div id="auth-right" style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh; text-align: center; width: 100%;">
            <img src="{{asset('mazer/assets/compiled/svg/logo.svg')}}" alt="Logo SMIRS Medina" style="max-width: 100%; height: auto;">
